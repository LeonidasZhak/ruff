...
class BaseWithSingleConsumer:
    def method[S](self: Consumer[S], value: S) -> None:
        pass

class SingleConsumerImplementation(BaseWithSingleConsumer):
    def put(self, value: int) -> None:
        pass

def keep[**P](callback: Callable[P, None]) -> Callable[P, None]:
    return callback

SingleConsumerImplementation().method("x")  # error: [invalid-argument-type]
# TODO: Retain the receiver constraint when inferring a `ParamSpec`.
# TODO: error: [invalid-argument-type]
keep(SingleConsumerImplementation().method)("x")
```
